...
class Application:
    ...
    def __container_menu(self):
        ...
        self.button_wpp = Button(self.buttons_container, justify='center', text='WhatsApp', bd=0, background=button_color, activebackground=button_clicked_color, command=self._frame_wpp)
